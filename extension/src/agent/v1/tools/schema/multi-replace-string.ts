 ...
 *
 * Optional features:
 * - <caseInsensitive>true</caseInsensitive> for case-insensitive matching
 * - <useRegex>true</useRegex> for regex patterns with capture groups ($1, $2)
 * - <order>1</order> to control replacement order
 */
