 ...
 * Pattern Search Tool
 *
 * Search for text patterns in multiple files. Use when you need to find where a function, variable, or text appears across files. Supports glob patterns and context lines.
 */
